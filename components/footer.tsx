...
export function Footer() {
  return (
    <footer className="border-t border-[color:rgba(255,243,223,0.08)] bg-[linear-gradient(180deg,rgba(12,10,9,0.94),rgba(8,6,6,0.98))]">
      <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6 sm:py-12 md:px-8 md:py-16">
        <div className="mb-8 h-px bg-[linear-gradient(90deg,transparent,rgba(255,243,223,0.18),transparent)]" />
        <div className="grid gap-8 md:grid-cols-2 xl:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div className="space-y-4 rounded-[2rem] border border-[color:rgba(255,243,223,0.1)] bg-[linear-gradient(180deg,rgba(255,243,223,0.08),rgba(255,243,223,0.03))] p-6 shadow-[0_18px_40px_rgba(0,0,0,0.18)]">
            ...
            <p className="max-w-md text-sm leading-7 text-[color:rgba(255,243,223,0.72)]">
              {siteDetails.address}
            </p>
          </div>
