...
export function MenuCategory({ category }: MenuCategoryProps) {
  return (
    <section className="rounded-[2rem] border border-[color:rgba(255,243,223,0.1)] bg-[linear-gradient(180deg,rgba(255,243,223,0.08),rgba(255,243,223,0.03))] p-5 shadow-2xl shadow-black/15 sm:p-6 md:p-8">
